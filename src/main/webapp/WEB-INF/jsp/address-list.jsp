...
<form method="get" action="${pageContext.request.contextPath}/main/address/list.html">
    Region:
    <th><input type="search" name="region" value="<%=request.getAttribute("region")%>"></th>
    City:
    <th><input type="search" name="city" value="<%=request.getAttribute("city")%>"></th>
    Street:
    <th><input type="search" name="street" value="<%=request.getAttribute("street")%>"></th>
    <input type="submit" value="Search">
    <input type="button" onclick="location.href='${pageContext.request.contextPath}/main/address/list.html';"
           value="Reset"/>
</form>
